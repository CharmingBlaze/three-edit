// Common utility functions for three-edit examples
...
function createAndAddMesh(scene, editableMesh, color, position) {
  try {
...
function visualizeVertices(scene, mesh, color, position) {
...
function visualizeEdges(scene, mesh, color, position) {
