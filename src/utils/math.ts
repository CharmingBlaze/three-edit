import { Vector3 as ThreeVector3, Matrix4 as ThreeMatrix4, Quaternion as ThreeQuaternion } from 'three';
...
export class Vector3 {
  ...
  toThree(): ThreeVector3 {
    return new ThreeVector3(this.x, this.y, this.z);
  }

  static fromThree(v: ThreeVector3): Vector3 {
  ...
  /**
   * Apply matrix4 transformation to this vector
   */
...
export class Quaternion {
  ...
  toThree(): ThreeQuaternion {
    return new ThreeQuaternion(this.x, this.y, this.z, this.w);
  }

  static fromThree(q: ThreeQuaternion): Quaternion {
...
export class Matrix4 {
  ...
  static fromThree(m: ThreeMatrix4): Matrix4 {
